...
@register('lte')
class LTE(pl.LightningModule):

    def __init__(self, encoder_spec, imnet_spec=None, hidden_dim=256, ckpt_path=None):
        super().__init__()        
        self.encoder = models.make(encoder_spec)
        print(f'LTE encoder out dim: {self.encoder.out_dim}')
